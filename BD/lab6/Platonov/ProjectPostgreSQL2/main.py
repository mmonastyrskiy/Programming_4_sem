import sys
# Структура импортов была слишком сложная и неправильно запихивать main во вложенные папки
...
class Main:
    ...
    def db_insert_somethings(self):
        pt = DriveTable()
        pht = CarTable()
        pt.insert_one(["Муравенко", "Павел", "Петрович", '27.11.2003', 121232, "MM", "111"])
        pt.insert_one(["Муравенко2", "Павел2", "Петрович2", '28.11.2003', 11232, "MM", "222"])
        pt.insert_one(["Муравенко", "Павел", "Петрович", '27.11.2003', 121232, "MM", "333"])

        pht.insert_one(["polo", "эконом","Черный", "1111", "1978", 1])# Добавил цвет авто
        pht.insert_one(["porche", "бизнес","Черный", "2222", "1976", 2])# Добавил цвет авто
        pht.insert_one(["golf", "комфорт","Черный", "3333", "2004", 3])# Добавил цвет авто
